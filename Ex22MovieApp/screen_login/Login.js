...
export default class Login extends Component{
        ...
        return (
            <View style={style.root}>
                ...
                <View style={style.content}>
                    ...
                    {/* 1.2 이메일/비밀번호 입력박스 */}
                    {/* 입력박스는 스타일작업을 해야 하는데 다른 .js문서에서도  */}
                    {/* 사용빈도가 높음. 각 문서마다 style작업을 하는것이 비효율적임*/}
    ...
    //TextInput에 글씨가 변경될때마다 그 글씨를 저장하는 작업을 하는 메소드
    changeEmail= (value)=>{
